...
const insertTopic = db.prepare("INSERT OR IGNORE INTO topics (id, name_it, name_en, description) VALUES (?, ?, ?, ?)");
...
const decisions = [
    ...
    // Foodinho / Glovo — algoritmo
    {
        ...
        summary: "Il Garante ha sanzionato Foodinho (Glovo) con 2,6 milioni di euro per uso illecito di algoritmi per la gestione dei rider — assenza di trasparenza sul funzionamento dell'algoritmo, raccolta eccessiva di dati di geolocalizzazione e mancata valutazione d'impatto.",
    ...
    // ENI Gas e Luce — telemarketing
    {
        ...
        summary: "Il Garante ha sanzionato ENI Gas e Luce con 11,5 milioni di euro per una vasta campagna di telemarketing illecito realizzata tramite call center terzi, senza consenso degli utenti e in violazione del Registro delle opposizioni (RPO).",
    ...
    // TikTok — minori
    {
        ...
        fine_amount: null,
        summary: "Il Garante ha ordinato a TikTok di bloccare immediatamente il trattamento dei dati degli utenti italiani di cui non era possibile accertare l'età, dopo il decesso di una bambina di 10 anni che partecipava a una sfida pericolosa diffusa sulla piattaforma.",
    ...
    // Wind Tre — telemarketing
    {
        ...
        summary: "Il Garante ha sanzionato Wind Tre con 16,7 milioni di euro per una sistematica attività di telemarketing realizzata tramite consensi non validamente acquisiti e per il mancato rispetto del diritto di opposizione degli utenti.",
