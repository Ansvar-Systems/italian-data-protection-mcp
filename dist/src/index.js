...
const TOOLS = [
    {
        ...
        description: "Full-text search across Garante decisions (provvedimenti, sanzioni, ordinanze). Returns matching decisions with reference, entity name, fine amount, and GDPR articles cited. Search in Italian for best results (e.g., 'consenso', 'videosorveglianza', 'Clearview').",
        inputSchema: {
            type: "object",
            properties: {
                query: {
    ...
    },
    {
        ...
        description: "Get a specific Garante decision by reference number (e.g., 'GPDP-2021-001', 'GARANTE-2022-CL').",
        inputSchema: {
            type: "object",
            properties: {
                reference: {
    ...
    },
    {
        ...
        description: "Search Garante guidance documents: linee guida, provvedimenti generali, and FAQ. Covers GDPR implementation, cookie e tracciamento, videosorveglianza, profilazione, telemarketing, and more.",
        inputSchema: {
            type: "object",
            properties: {
                query: {
    ...
    },
    {
        ...
        description: "List all covered data protection topics with Italian and English names. Use topic IDs to filter decisions and guidelines.",
        inputSchema: {
            type: "object",
            properties: {},
            required: [],
        ...
        switch (name) {
            ...
            case "it_dp_about": {
                return textContent({
                    name: SERVER_NAME,
                    version: pkgVersion,
                    description: "Garante per la protezione dei dati personali MCP server. Provides access to Italian data protection authority decisions, sanctions, prescriptions, and official guidance documents including linee guida and provvedimenti generali.",
