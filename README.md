...
[![npm version](https://badge.fury.io/js/%40ansvar%2Fitalian-data-protection-mcp.svg)](https://www.npmjs.com/package/@ansvar/italian-data-protection-mcp)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![CI](https://github.com/Ansvar-Systems/italian-data-protection-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/italian-data-protection-mcp/actions/workflows/ci.yml)
...
**Endpoint:** `https://mcp.ansvar.eu/italian-data-protection/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add italian-data-protection-mcp --transport http https://mcp.ansvar.eu/italian-data-protection/mcp` |
...
```json
{
  "mcpServers": {
    "italian-data-protection-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/italian-data-protection/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/italian-data-protection-mcp
```
...
```json
{
  "mcpServers": {
    "italian-data-protection-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/italian-data-protection-mcp"]
    }
  }
}
```
...
| Tool | Description |
|------|-------------|
| `it_dp_search_decisions` | Full-text search across Garante decisions (provvedimenti, sanzioni, ordinanze). Returns matching decisions with refer... |
| `it_dp_get_decision` | Get a specific Garante decision by reference number (e.g., |
| `it_dp_search_guidelines` | Search Garante guidance documents: linee guida, provvedimenti generali, and FAQ. Covers GDPR implementation, cookie e... |
| `it_dp_get_guideline` | Get a specific Garante guidance document by its database ID. |
| `it_dp_list_topics` | List all covered data protection topics with Italian and English names. Use topic IDs to filter decisions and guideli... |
| `it_dp_about` | Return metadata about this MCP server: version, data source, coverage, and tool list. |
